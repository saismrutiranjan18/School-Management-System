        ...
        {result ? (
          <div className="text-center py-4">
            ...
            {result.fine_amount > 0 && (
              <div className={`p-3 rounded-lg mb-3 text-sm ${result.fine_paid ? 'bg-green-50 text-green-700' : 'bg-yellow-50 text-yellow-700'}`}>
    ...
    <div className="p-6">
      ...
      <div className="flex gap-1 mb-5 bg-gray-100 p-1 rounded-lg w-fit">
        {[
          ...
          { key: 'overdue', label: `⚠️ Overdue${overdueCount > 0 ? ` (${overdueCount})` : ''}` },
        ].map(t => (
          <button
            key={t.key}
